...
basepath="D:/100%_music_recommendation_new_gui_ready/100%_music_recommendation_new_gui_ready"
...
label_l1 = tk.Label(root, text=" Music Recommendation System",
                    font=("Times New Roman", 50, 'bold'),
                    background="pink", fg="black", height=1)
...
button3 = tk.Button(root, text=" Expression Evaluation ", command=social,width=19, height=1, font=('times', 15, ' bold '),bg="lightblue",fg="black")
...
button4 = tk.Button(root, text=" Recommend Music ", command=prediction_emotion1,width=19, height=1, font=('times', 15, ' bold '),bg="lightblue",fg="black")
...
exit = tk.Button(root, text="Exit", command=window, width=19, height=1, font=('times', 15, ' bold '),bg="blue",fg="white")
