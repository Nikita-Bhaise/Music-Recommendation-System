...
def play_song():
    ...
    playsound('sad/Agar Tum Saath Ho.mp3')
    
def play_song1():
    from playsound import playsound
    playsound('sad/Channa Mereya Ae Dil Hai Mushkil.mp3')   
    
def play_song2():
    from playsound import playsound
    playsound('sad/Humdard.mp3')   
    
def play_song3():
    from playsound import playsound
    playsound('sad/kabira.mp3')    
    
    
def play_song4():
    from playsound import playsound
    playsound('sad/kar har maidan fateh.mp3')  
    
def play_song5():
    from playsound import playsound
    playsound('sad/Phir Se Ud Chala.mp3')    

def play_song6():
    from playsound import playsound
    playsound('sad/tuze kitna chahne lage hum.mp3')  

# def play_song7():
#     from playsound import playsound
#     playsound('sad/Bekhayali - Arijit Singh Version.mp3')     
...
image3 = Image.open(r"sad/Agar Tum Saath Ho.jpg")
image3 = image3.resize((100, 100), Image.ANTIALIAS)
background_image3 = ImageTk.PhotoImage(image3)
background_label3 = tk.Label(root, image=background_image3,text="Agar Tum Saath Hoo",compound='bottom')
...
image4 = Image.open(r"sad/Channa Mereya Ae Dil Hai Mushkil.jpg")
...
image5 = Image.open(r"sad/Humdard.jpg")
image5 = image5.resize((100, 100), Image.ANTIALIAS)
background_image5 = ImageTk.PhotoImage(image5)
background_label5 = tk.Label(root, image=background_image5,text="Humdard",compound='bottom')
...
image6 = Image.open(r"sad/kabira.jpg")
image6 = image6.resize((100, 100), Image.ANTIALIAS)
background_image6 = ImageTk.PhotoImage(image6)
background_label6 = tk.Label(root, image=background_image6,text="kabira",compound='bottom')
background_label6.image = background_image6
background_label6.place(x=1200, y=140)
...
image7 = Image.open(r"sad/kar har maidan fateh.jpg")
image7 = image7.resize((100, 100), Image.ANTIALIAS)
background_image7 = ImageTk.PhotoImage(image7)
background_label7 = tk.Label(root, image=background_image7,text="kar har maidan fateh",compound='bottom')
...
image8 = Image.open(r"sad/phir se ud chala.jpg")
image8 = image8.resize((100, 100), Image.ANTIALIAS)
background_image8 = ImageTk.PhotoImage(image8)
background_label8 = tk.Label(root, image=background_image8,text="phir se ud chala",compound='bottom')
...
image9 = Image.open(r"sad/tuze kitna chahne lage hum.jpg")
image9 = image9.resize((100, 100), Image.ANTIALIAS)
background_image9 = ImageTk.PhotoImage(image9)
background_label9 = tk.Label(root, image=background_image9,text="kabir singh",compound='bottom')
background_label9.image = background_image9
background_label9.place(x=850, y=340)
button7 = tk.Button(root, text="Play ",command=play_song6,height=1,width=10,font=('times', 15, ' bold '), bg="brown4", fg="white")
button7.place(x=850, y=450)
    
    
# image10 = Image.open(r"sad/tuze kitna chahne lage hum.jpg")
# image10 = image10.resize((100, 100), Image.ANTIALIAS)
# background_image10 = ImageTk.PhotoImage(image10)
# background_label10 = tk.Label(root, image=background_image10,text="Bekhayali mai ",compound='bottom')
# background_label10.image = background_image10
# background_label10.place(x=1200, y=340)
# button8 = tk.Button(root, text="Play ",command=play_song7, height=1,width=10,font=('times', 15, ' bold '), bg="brown4", fg="white")
# button8.place(x=1200, y=450)
